...
def run():
    ...
    try:
        ...
        if len(py_files) > 0:
            ...
            stdin, stdout, stderr = ssh.exec_command(f'cd {remote_current_working_directory}; {remote_python_interpreter} {main_py} --ip=192.168.56.102,192.168.56.103', bufsize=1, get_pty=True)
